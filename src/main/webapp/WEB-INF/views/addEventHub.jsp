...
<script type="text/javascript">
    ...
    function insRow() {
        ...
        var eventHubName = 'eventHubName'+count;
        var eventHubURL = 'eventHubURL'+count;
        ...
        var frmTag = "<input type=text name=" + "'" + eventHubName + "'" + "style=width:200px; height:20px; placeholder='eventHubName'>";
        frmTag += "<input type=text name=" + "'" + eventHubURL + "'" + "style=width:200px; height:20px; placeholder='eventHubURL'>";
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                ...
                <a href="/assets/addPeer" class="list-group-item ">Peer</a>
                <a href="/assets/addOrderer" class="list-group-item">Orderer</a>
                <a href="#" class="list-group-item active">EventHub</a>
            </div>
        </div>
        <!-- /.col-lg-3 -->
        ...
        <div class="col-lg-9">
            ...
            <div class="card card-outline-secondary my-4">
                <div class="card-header">
                    <h1>Set EventHub Config</h1>
                    <div align="right">
                        <input name="addButton" class="btn btn-success" type="button" style="cursor:hand" onClick="insRow()" value="Add EventHub">
                        <%--                    <font color="#FF0000">*</font>Add user--%>
                    </div>
                </div>
                <div class="card-body" algin="right">
                    <form action="/assets/setEventHub" method="post" enctype="multipart/form-data">
