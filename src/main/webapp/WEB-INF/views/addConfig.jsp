    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item active"l>Config</a>
...
<%--                </div>--%>
            ...
            <div class="card-body" algin="right">
                <form action="/assets/setConfig" method="post" enctype="multipart/form-data">
                    ...
                    <table width="780">
                        <tr>
                            <td>
                                caURL <input type="text" name="caURL" id="caURL" value="http://localhost:7054" class="btn-outline-info">
                            </td>
                            <td>
                                channelName <input type="text" name="channelName" id="channelName" value="mychannel" class="btn-outline-info">
                            </td>
                            <td>
                                chaincodeName <input type="text" name="chaincodeName" id="chaincodeName" value="mycc" class="btn-outline-info">
                            </td>
