...
public class Config {
	...
	public static String CA_ORG1_URL = null;//"http://localhost:7054";

	public static String CHANNEL_NAME = null;//"mychannel";

	public static String CHAINCODE_1_NAME = null; //"mycc";

	public static String ADMIN = null; //"admin";

	public static String ADMIN_PASSWORD = null;//"adminpw";
